    ...
    if (isset($_GET['id'])) {
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            <form action="./backend/edit.php" method="post" enctype="multipart/form-data">
                ...
                <input class="form-control form-control-sm" type="text" name="name" placeholder="Input nama produk"
                    value="<?= $row['name']; ?>">
                <input class="form-control form-control-sm" type="number" name="price" placeholder="Input harga produk"
                    value="<?= $row['price']; ?>">
                <p>Gambar Saat Ini:
                    <?= $row['image']; ?>
                </p>
